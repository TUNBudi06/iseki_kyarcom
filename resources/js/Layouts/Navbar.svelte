...
<DefaultLayout>
    ...
    >
        ...
        <!-- Main Content -->
        <main class="mx-auto max-w-8xl px-4 py-8 sm:px-6 lg:px-8">
            {@render children?.()}
        </main>

        <!-- Footer -->
        <footer
            class="mt-auto border-t border-slate-200 bg-white/80 backdrop-blur-sm dark:border-slate-800 dark:bg-slate-900/80"
        >
